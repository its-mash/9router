...
export const OAUTH_PROVIDERS = {
  claude: { id: "claude", alias: "cc", name: "Claude Code", icon: "smart_toy", color: "#D97757", deprecated: true, deprecationNotice: RISK_NOTICE, website: "https://claude.ai", notice: { signupUrl: "https://claude.ai" }, serviceKinds: ["llm", "webSearch"], searchViaChat: { defaultModel: "claude-haiku-4-5", pricingUrl: "https://www.anthropic.com/pricing", freeTier: "Uses your connected Claude Code subscription — Haiku + native server-side web_search; the highest-quality fulfiller for the Claude-Code web_search shim." } },
...
export const APIKEY_PROVIDERS = {
  ...
  anthropic: { id: "anthropic", alias: "anthropic", name: "Anthropic", icon: "smart_toy", color: "#D97757", textIcon: "AN", website: "https://console.anthropic.com", notice: { apiKeyUrl: "https://console.anthropic.com/settings/keys" }, serviceKinds: ["llm", "imageToText", "webSearch"], searchViaChat: { defaultModel: "claude-haiku-4-5", pricingUrl: "https://www.anthropic.com/pricing", freeTier: "Uses your Anthropic credits — Haiku + native server-side web_search is cheap, and the highest-quality fulfiller for the Claude-Code web_search shim." } },
